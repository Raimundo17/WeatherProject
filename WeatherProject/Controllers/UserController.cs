...
namespace WeatherProject.Controllers
{
    public class UserController : Controller
    {
        ...
        public UserController(IUserHelper userHelper, IMailHelper mailHelper ,IConfiguration configuration, IImageHelper imageHelper)
        {
        ...
        public async Task<IActionResult> Register(RegisterViewModel model)
        {
            if (ModelState.IsValid)
            {
                ...
                if (user == null)
                {
                    ...
                    await _userHelper.AddUserToRoleAsync(user, "visitor");
